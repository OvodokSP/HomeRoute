...
plan_field hrneo_rescue LIVE_PACKAGE_FILES_PASS_OPKG_CONTROL_GATE_READY
plan_field backup_restore LIVE_FILESYSTEM_AND_HRNEO_FILES_PASS_OPKG_CONTROL_CAPTURE_PENDING
