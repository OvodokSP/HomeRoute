...
for expected in \
    ...
    'HOMEROUTE_PLAN dns_redirect=RENDERER_TESTED_LIVE_TIMER_IDENTITY_CAPTURED' \
    'HOMEROUTE_PLAN dns_persistence=TIMER_ACTIVE_ENABLED_HELPER_HASH_CAPTURED' \
    'HOMEROUTE_PLAN dns_helper_analysis=READY_FOR_LIVE_SANITIZED_FINGERPRINT' \
