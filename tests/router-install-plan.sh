...
for expected in \
    ...
    'HOMEROUTE_PLAN hrneo_rescue=LIVE_PACKAGE_FILES_AND_OPKG_CONTROL_PASS_STATUS_DB_GATE_READY' \
    'HOMEROUTE_PLAN backup_restore=LIVE_FILESYSTEM_HRNEO_FILES_OPKG_CONTROL_PASS_STATUS_DB_GATE_READY' \
