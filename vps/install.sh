...
plan_field awg_restore LIVE_SAME_STATE_RESTORE_VERIFIED
plan_field exact_image_rescue LIVE_EXPORT_VERIFIED
plan_field adguard_state_backup LIVE_BACKUP_VERIFIED
plan_field adguard_restore LIVE_SAME_STATE_RESTORE_VERIFIED
...
plan_field dns_redirect RENDERER_TESTED_LIVE_TIMER_MONOTONIC_CAPTURED
plan_field dns_persistence DESIRED_STATE_PLAN_TESTED_LIVE_TIMER_VERIFIED
plan_field dns_helper_analysis SCHEMA2_LIVE_PARTIAL_TARGET_SOURCE_NOT_VALIDATED
...
plan_field live_adguard_restore_validation LIVE_PASS
