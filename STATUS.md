...
| DNS timer schedule | FIRST CAPTURE INCONCLUSIVE; CALENDAR/MONOTONIC PRECHECK v2 READY |
| DNS helper semantics | SANITIZED ANALYZER CI TESTED; LIVE FINGERPRINT PENDING |
