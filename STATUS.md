...
| AWG restore algorithm | SANDBOX PASS + ISOLATED LIVE REHEARSAL PASS; CONTROLLED SAME-STATE LIVE VALIDATOR READY; LIVE VALIDATION PENDING |
...
| Live backup/restore | VPS FILESYSTEM + AWG/ADGUARD BACKUPS PASS; EXACT IMAGES SAVED; READ-ONLY READINESS PASS; ISOLATED STOPPED-CONTAINER REHEARSAL LIVE PASS; LIVE SERVICE RESTORE + ROUTER PENDING |
