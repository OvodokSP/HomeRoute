...
| Live backup/restore | VPS FILESYSTEM + AWG/ADGUARD BACKUPS PASS; EXACT IMAGES SAVED; READ-ONLY READINESS + ISOLATED STOPPED-CONTAINER REHEARSAL READY; LIVE SERVICE RESTORE + ROUTER PENDING |
