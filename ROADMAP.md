...
- [ ] HL-102 — Добавить схемы результатов inventory и примеры без реальных адресов, ключей и конфигураций.
- [ ] HL-103 — Определить методику классов «не подходит / достаточно / рекомендуется» без неподтверждённых числовых порогов.
